    ...
    return (
        ...
        <div
          style={{
            ...
            paddingLeft: '20px', // optional spacing between "YOUR" and text column
          }}
        >
          <div style={{ fontSize: '40px' }}>Vibe</div>
          <div style={{ fontSize: '40px' }}>Tribe</div>
          <div style={{ fontSize: '40px' }}>Next Plan</div>
        </div>
      </div>

      <div style={{ paddingLeft: '30px', fontSize: '30px' }}>
        All at ONE place.
      </div>
                            </h1>
